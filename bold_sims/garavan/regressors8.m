...
% Input Stimulus:  square wave starting of width 370 msec.
% centered around the reaction time after the onset of the stimulus 
...
% 
% The file 'lagstart.mat' must also be present.  
%  It contains the lagtimes
...
save regressors8 resp  baseline operation counter operation dual clean
