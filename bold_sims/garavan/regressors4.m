...
%
% Input Stimulus:  Square waves from 180 msec after stimulus onset
% until 550 msec. after stimulus onset.
%
...
% Constants for GAmma variate function (using msec units)
delta=2500/2000;
tau = 1250/2000;
...
dual = resp(:,4);
baseline=resp(:,5);
save regressors4 resp baseline operation counter noswitch dual
colormap('gray');
imagesc(resp);
