function t_score = bold_shift_sim1b(noise, tau, iti)
% function t_score = bold_shift_sim1b(noise, tau, iti)
%
% Luis Hernandez
...
% 
%
% Output:  a row of t-scores as a function of the time shift (from -2 to 2 seconds)
% 
...
for delay= -2: 0.2 : 2
      ...
      x = model(2*SECONDS + delay *SECONDS+1:TR*SECONDS: size(model)-2*SECONDS +delay*SECONDS);
