function [echo, im_all] = spiral3drecon_200729(myPfile, doRots, useKrot, Ndel, doGoldenAngle)
% function im_all = spiral3drecon_200729(myPfile, doRots, useKrot, Ndel, doGoldenAngle)
%
% spiral3drecon
%
...
save gkdata20.mat gkdata tmpk im
return
