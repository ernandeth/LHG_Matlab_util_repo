function M = blochsim2(Mi, beff, T1, T2, dt, nstep)
% Usage ... M = blochsim2(Mi, beff, T1, T2, dt, nstep)
%
% Mi - initial state of the magnetization vector (1x3)
% beff - Effectice Magnetic field vector over time (nstep x 3).
% T1 - longitudinal relaxation in ms
% T2 - transverse relaxation in ms.
% dt - size of each step in ms
% nstep - number of steps in the simulation.
% 
