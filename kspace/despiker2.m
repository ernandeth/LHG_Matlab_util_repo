function indices=despiker2(pfilename ,fastrecflag, showData ,year,cut)
% Usage ... indices = despiker(pfile,fastrecflag, showData [,year][,cut])
%
% search for spikes in the kspace data and replace them by the mean of
% that point in kspace over the time series.
%
% a spike is defined as a point that has a value 3stdDev greater than the
