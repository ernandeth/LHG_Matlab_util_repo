...
%   
%   Modified by Tom Nichols to automatically name output file.
%
% @(#)homocor.m	1.2 01/08/27
...
Yc_vol = vol;
Yc_vol.fname   = out_path;
Yc_vol.descrip ='homocor';

Yc_vol = spm_create_image(Yc_vol);
for p=1:Yc_vol.dim(3),
        Yc_vol = spm_write_plane(Yc_vol,Yc(:,:,p),p);
end




% From John Ashburner's spm_reslice.m ver 2.4
