%  function strFileOut = sprec1_par(args,scaninfo,kinfo)
 function imgOut = sprec1_par(args,scaninfo,kinfo)
%  sprec1_par.m - same behavior as sprec1.m but takes args, scaninfo, and
%  kinfo structures as inputs (this layout best for parallel processing)
% 
% Copyright 2005
...
% $HeadURL: svn+ssh://klitinas@woo.engin.umich.edu/work/repos/matlab/recon/trunk/sprec1_par.m $
% $Id: sprec1_par.m 1656 2015-01-12 16:20:32Z klitinas $
  ...
  strFileOut='fmfile.mat';
    ...
    for phnum = stph:enph-1
      ...
      % write out full arrays
       if isfield(args,'outname')
            % basestr = sprintf('vol_e%d_%s_%04d_sl%s',scaninfo.exam,datestr,phnum+args.imoffset,args.outname);
            basestr = args.outname;
        else
