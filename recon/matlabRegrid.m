...
% kSpace1 = griddata(K(:,1)',K(:,2),spData,KXi,KYi,'v4'); 
kSpace1 = griddata(K(:,1)',K(:,2),spData,KXi,KYi); 
kSpace1(isnan(kSpace1)) = 0;

% % Trying to catch that DC error!!!
% dc_offset = mean(mean(kSpace1(1:3,1:3)))
% kSpace1 = kSpace1 - 15- 20*i;
%%%%%%%%%%%%%%%%%%%%%
