...
function  [dta2, procpar] = getSpiralFid(fileLocation, reps)
...
dta = reshape(dta, n,sl, reps*Nint);  % Reshape for processing.

dta2 = zeros(n, reps*Nint,sl);  % Preallocate for speed.
