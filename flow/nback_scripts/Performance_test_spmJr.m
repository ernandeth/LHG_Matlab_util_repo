...
destinationDir =[ rootDir filesep 'groupResults/performance/4back_1back']
FLC = 1;
%close all
for mycontrast = 1:4;
    ...
    switch (mycontrast)
        case 1
            destinationDir = [ rootDir filesep 'groupResults/performance/baseline']
            FLC = 1;  % first level contrast:   1 = baseline,     4 = 4back-1back

        case 2
            destinationDir = [ rootDir filesep 'groupResults/performance/4back']
            FLC = 2;  % first level contrast:   1 = baseline,     4 = 4back-1back

        case 3
            destinationDir = [ rootDir filesep 'groupResults/performance/1back']
    ...
    if doTest
        ...
        perform = load('/home/data/asl/mfiles/P1.txt');
    ...
    if doFigures
        ...
        feffect = read_img2([ destinationDir '/Zmap_0001']);
        msk = read_img2([ destinationDir '/Zmap_0001.img']);
        ...
        act_lightbox(f0_b, feffect_b, [0 80], [2  5], 1);
        title(destinationDir)
        
        print -dtiff correlationwithP1
