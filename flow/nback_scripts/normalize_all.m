...
for s=1:size(subjs,1)
    ...
    % remove leftover parameter files and previous normalization attempts
    str = (['!rm ' rootDir  subjDir '/run_01/w*']) ; eval (str)
    str = (['!rm ' rootDir  subjDir '/run_01/*_sn.mat']) ; eval (str)
    ...
    jobs{1}.spatial{1}.normalise{1}.estwrite.subj.source{1} = ...
    ...
    spm_jobman('run', jobs);
    %
   smoother3(  [ rootDir  subjDir '/run_01/wExpFlows.img'], 5);
    ...
    % remove leftover parameter files and previous normalization attempts
    str = (['!rm ' rootDir  subjDir '/run_02/w*']) ; eval (str)
    str = (['!rm ' rootDir  subjDir '/run_02/*_sn.mat']) ; eval (str)
    ...
    smoother3(  [ rootDir  subjDir '/run_02/wExpFlows.img'], 5);
