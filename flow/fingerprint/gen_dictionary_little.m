...
fvals = linspace(0, 100, 3)/6000;
%fvals = 40/6000;

cbvavals = [linspace(0.0, 0.1,3) 1];

transvals = linspace(0.5, 2.5, 3);
%transvals = 0.8;

%kforvals = linspace(0.0,1,5);
kforvals = 0.005;

%r1vals = 1./linspace(0.5,3,5);
r1vals = 1./[0.7:0.1:1.8 2.5];
r1vals = 1./[0.9 1.4 3];

betavals = [50:10:70] * pi/180;
betavals = deg2rad(80);
...
save dictionary_little  dict parms ;
