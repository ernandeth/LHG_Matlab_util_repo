...
TR =        sort(repmat( linspace(2.2, 4, 40) , [1,4]) , 'descend');
label_dur = sort(repmat( linspace(0.2, 1.8, 40) , [1,4]), 'descend'); %  ]TR - 0.600 - 0.300;
PID =       sort(repmat( linspace(0.2, 1.8, 40) , [1,4]), 'descend');

label_dur(1:8:end) = 0;
label_dur(2:8:end) = 0;


TR =        sort(repmat( linspace(1.2, 4.4, 20) , [1,6]) , 'descend');
label_dur = sort(repmat( linspace(0.2, 1.8, 20) , [1,6]), 'descend'); %  ]TR - 0.600 - 0.300;
PID =       sort(repmat( linspace(0.2, 1.8, 20) , [1,6]), 'descend');

TR =        sort(repmat( 0.4+[3.6 : -0.096 : 1] , [1,6]) , 'descend');
label_dur = sort(repmat( 0.4+[1.4 : -0.048 : 0.10] , [1,6]), 'descend'); %  ]TR - 0.600 - 0.300;
PID =       sort(repmat( [1.4 : -0.048 : 0.10], [1,6]), 'descend');
