...
ObjectiveFunction = @dictionary_correlation_150507;
nvars = 80;    % Number of acquisitions - 3 variables at each iteration
maxTR = 3;
...
timing_parms.t_adjust = maxTR - timing_parms.PID - timing_parms.label_dur;
...
t_delays = timing_parms.PID' - 0.010;
t_adjusts =timing_parms.t_adjust' - 0.006;
