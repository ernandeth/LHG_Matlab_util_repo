% 
%% optimize and generate 200 point ASL signal dictionary. The signal dictionary is optimized upon minimizing the correlation between each dictionary members of subtraction pairs.
...
ObjectiveFunction = @gmin_mix_0731_r; % the target function has been modified with
nvars =200;    % Number of variables
...
save optimalTiming_140731b timing_parms dict parms
