function [T1, M0]=sr_fit3 ( TR, Thres, root, reps)
% function [T1,  M0]=sr_fit3(TR_vector, maskTh, root, reps)
%
% last edit: 9/2/2006
% Luis Hernandez-garcia @ UM
%
% TR_vector  = TR's in the series
% maskTh = fraction of the median of the last image to use as
%	a threshold for masking.
% root = the rootname of the filenames in the series of images
%	example:  "control_'
% reps = number of images acquired at each TR.  
% 	The script will use only the last one at each TR
%
% This function fits the parameters Mo and T1 to the function
%
%	M(t) = abs [ Mo(1- theta* exp(-TR/T1) ) ]
%
