...
sprec1_3d(Pfile,'n', 128, 'com','N', 'fy','l');
%sprec1_3d(Pfile,'n', 128,'N', 'fy','l');
...
figure
subplot(221); delta = lightbox('mean_sub'); title('abs(control-tag)'); caxis([-1 1]*4e2)
subplot(222); lightbox('mean_magDiff'); title('abs(control)-abs(tag)');caxis([-1 1]*4e2)
