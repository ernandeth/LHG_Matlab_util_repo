...
% aslsub(volname(1:end-4), 4, 1, hdr.tdim, 0, 0, 0);
aslsub(volname(1:end-4), 4, 5, hdr.tdim, 0, 0, 0);
...
str2 = sprintf('\n THE RECOMMENDED PHASE INCR. IS  %0.2f (SIGNA) or %0.2f (DISCO)', (ind-1)*0.2, (ind-1)*0.4);

figure(33)
slices02('sub',[0 300]) ; axis image
