...
if ~doBatch
    ...
    flip_ang0 = 20;
    flip_ang = 160;
    isTag = 0;  % this means that the pulse's sign oscillates
    vel = 40;
    slomo =0;
    
    eta = 0.75;   % works for all locs if eta = 0.25!!
...
%%
t_rfrepeat = 2.0; % ms - this is the interval between pulses in terms of the scanner variable
...
flip_ang0 = flip_ang0 * pi /180;  % flip angle in radians
