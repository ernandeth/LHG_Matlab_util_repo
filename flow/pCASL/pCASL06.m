...
%
% (9/5/08) this version is for reducing the slice selcet gradient and acoustic noise
% no major changes, just playing around with parameter settings
...
Gz_ss = 0.3;  % slice select gradient in G/cm.
