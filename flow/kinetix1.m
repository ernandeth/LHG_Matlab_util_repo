% generates an ASL signal and estiamtes the perfusion from it
% can be used to iterate over regularization params.... noise...
%
% Used for first draft of modeling papaer
% Does not estimate the baseline separately
%
