function [fid_new,sldat,sldat_new]=physio_correct(fname,order,resp_flag,card_flag,resp_phases,card_phases,strt_time, Nframes);
%
...
if ((computer)=='GLNX86')
  fid_old=fopen(fname,'r','b');
  fid_new=fopen(fname_new,'w','b');
else
  fid_old=fopen(fname,'r');
  fid_new=fopen(fname_new,'w');
end;
