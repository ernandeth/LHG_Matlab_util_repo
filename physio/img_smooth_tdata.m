function outdata = img_smooth_tdata(filename,  TR, cutoff, N_coeffs,  verbose)
% function outdata = smoothdata(filename,  TR, cutoff, N_coeffs [,verbose])
%
%
...
%
% filename  - a file of input 4D data
...
outdata = zeros(size(data));
    ...
    parfor p=1:Npix
        outdata(:,p) = filtfilt(b,1, data(:,p));
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    write_nii(['ts_' filename], outdata, avw2nii_hdr(h), 0);
if (nargin==5)
% Show the details to the users...
