...
% $Id: sprec1_flip.m 1266 2014-03-20 18:12:40Z klitinas $
...
%  rtype = 'ft'; % do straight ft recon for field mapping
  ...
  for slnum = stsl:ensl-1
    ...
    dat0 = loaddat_ex2_flip(0,slnum,scaninfo,fid);
    dat1 = loaddat_ex2_flip(1,slnum,scaninfo,fid);
    immap = zeros([nim nim]);
  ...
  strFileOut='fmfile.mat';
    ...
    for phnum = stph:enph-1
      ...
      for slnum = stsl:ensl-1
        ...
        dat = loaddat_ex2_flip(phnum,slnum,scaninfo,fid);
        for coilnum = 1:ncoils 
