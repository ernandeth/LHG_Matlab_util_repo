...
% this version uses Hui's event detection
...
%     b = b - mean(b);
    ...
    a_events = events_detect(a, hrf_c);
    b_events = events_detect(b, hrf_c);
    ...
    [Fab , Fba, chi2] = granger_inst(a_raw, b_raw, Xmodel, Nlag,  0);
