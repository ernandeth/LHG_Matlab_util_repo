function org_val3(orgx,orgy,orgz);
% RCWelsh 10/11/99 - Modified to take input for the origin. 
%
...
%orgx = 3.3; % <--- Origin Location along R/L (+R/-L in mm)
%orgy = 24.2; % <--- Origin Location along A/P (+A/-P in mm)
%orgz = 16.3; % <--- Origin Location along S/I (+S/-I in mm)
% **********************************************************
% **********************************************************
% **********************************************************
